    ...
    >
      ...
      <SwiperSlide>
        ...
        <div className="absolute bottom-[5vh] lg:bottom-[10vw] left-[10vw] z-1">
          ...
          <p className="text-black text-sm lg:text-xl mb-5 w-4/5 lg:w-[600px] font-extralight">
            ¡Notá los cambios!
          </p>
        </div>
      </SwiperSlide>
      <SwiperSlide>
        ...
        />
        <div className="absolute bottom-[5vh] lg:bottom-[10vw] left-[10vw] z-1">
          <h1 className="text-black text-2xl lg:text-7xl mb-5 lg:w-[800px] leading-tight">
